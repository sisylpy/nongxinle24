...
public class SysMenuServiceImpl implements SysMenuService {
	...
	@Override
	public List<SysMenuEntity> getUserMenuListCode(Long userId) {
		System.out.println("iamcodeuser");
		...
		//用户菜单列表
		List<Long> menuIdList = sysUserService.queryAllMenuIdCode(userId);
		return getAllMenuList(menuIdList);
	}
